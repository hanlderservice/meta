 ...
 */
@Component
public class StrengthenRestTemplate {
    ...
    public <T> ResponseEntity<T> get(String url, Class<T> responseType) throws RestClientException {
        return getTemplate().getForEntity(url, responseType);
    }
    ...
    public <T> ResponseEntity<T> get(String url, Class<T> responseType, Object... uriVariables)
        ...
        return getTemplate().getForEntity(url, responseType, uriVariables);
    }
    ...
    public <T> ResponseEntity<T> post(String url, Class<T> responseType) throws RestClientException {
        return getTemplate().postForEntity(url, HttpEntity.EMPTY, responseType);
    }
    ...
    public <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType)
            throws RestClientException {
        return getTemplate().postForEntity(url, requestBody, responseType);
    }
    ...
    public <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType, Object... uriVariables)
            throws RestClientException {
        return getTemplate().postForEntity(url, requestBody, responseType, uriVariables);
    }
    ...
    public <T> ResponseEntity<T> post(String url, HttpEntity<?> requestEntity, Class<T> responseType,
                                      Object... uriVariables) throws RestClientException {
        return getTemplate().exchange(url, HttpMethod.POST, requestEntity, responseType, uriVariables);
    }
    ...
    public <T> ResponseEntity<T> put(String url, HttpEntity<?> requestEntity, Class<T> responseType,
                                     Object... uriVariables) throws RestClientException {
        return getTemplate().exchange(url, HttpMethod.PUT, requestEntity, responseType, uriVariables);
    }
    ...
    public <T> ResponseEntity<T> delete(String url, HttpEntity<?> requestEntity, Class<T> responseType,
                                        Object... uriVariables) throws RestClientException {
        return getTemplate().exchange(url, HttpMethod.DELETE, requestEntity, responseType, uriVariables);
    }
    ...
    public <T> ResponseEntity<T> exchange(String url, HttpMethod method, HttpEntity<?> requestEntity,
                                          Class<T> responseType, Object... uriVariables) throws RestClientException {
        return getTemplate().exchange(url, method, requestEntity, responseType, uriVariables);
    }
